...
labels = df['label']
X_train, X_test, y_train, y_test = train_test_split(features,labels,random_state=random_state) # tried using a different means of splitting, but it wasn't much more accurate,
...
accuracy_score(predictions3,y_test3)


# this random_state was forced. Many that I tried had a slightly lower score
