...
def evaluate_deriv(D, qs,q_vals):
    q1,q2,q3,q4 = qs
    D1 = sp.lambdify((q1,q2,q3,q4), D[0] ,"numpy")
    D2 = sp.lambdify((q1,q2,q3,q4), D[1] ,"numpy")
    D3 = sp.lambdify((q1,q2,q3,q4), D[2] ,"numpy")
    D4 = sp.lambdify((q1,q2,q3,q4), D[3] ,"numpy")
    #D2 = sp.diff(eq1(q1,q2,q3,q4),q2)
    #D3 = sp.diff(eq1(q1,q2,q3,q4),q3)
    #D4 = sp.diff(eq1(q1,q2,q3,q4),q4)
    ...
    #D7 = sp.diff(eq1(q1,q2,q3,q4),q3)
    #D8 = sp.diff(eq1(q1,q2,q3,q4),q4)
    D5 = sp.lambdify((q1,q2,q3,q4), D[4] ,"numpy")
    D6 = sp.lambdify((q1,q2,q3,q4), D[5] ,"numpy")
    D7= sp.lambdify((q1,q2,q3,q4), D[6] ,"numpy")
    D8= sp.lambdify((q1,q2,q3,q4), D[7] ,"numpy")
    return D1,D2,D3,D4,D5,D6,d7,D8

print('in derivs')

#D1, D2, D3, D4 = differentiate()


Ds = differentiate(q1,q2,q3,q4)
...
qs = [q1_val,q2_val,q3_val,q4_val]

D1, D2, D3, D4, D5, D6, D7, D8 = evaluate_deriv(Ds,qs)
